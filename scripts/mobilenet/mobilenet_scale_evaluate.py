# python3 ./scripts/mobilenet/mobilenet_scale_evaluate.py
import json
import os
import torch
...
WEIGHTS_PATH = "./runs/classify/mobilenetv4_bcst_90/weights/best.pt"
SCALE_DIR = "dataset/flame_scale_eval"
OUTPUT_PATH = "mobilenet_flame_bcst_90_result.json"
IMG_SIZE = 224
