# python3 ./scripts/mobilenet/mobilenet_patch_train.py
# Crops 8px patches from images/cctv + images/forest using patches_index.csv,
# then trains MobileNet classify. No FLAME eval.
import csv
import json
import os
import random
...
SAVE_DIR = ROOT / "runs" / "classify" / "mobilenetv4_patch_8"
...
def main():
    ...
    print(f"\n=== training MobileNet on patch-{SIZE} ===")
    train(data_dir)
