# python3 ./scripts/mobilenet/mobilenet_transfer_finetune.py
import os
import torch
...
MODEL_A = "runs/classify/mobilenetv4/weights/best.pt"
DATA_DIR = "dataset/forest_train_split"
EPOCHS = 5
BATCH_SIZE = 8
IMG_SIZE = 224
LR = 0.0001
SAVE_DIR = "runs/classify/mobilenetv4_transfer_forest"
