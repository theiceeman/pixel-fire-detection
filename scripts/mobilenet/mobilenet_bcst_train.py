# python3 ./scripts/mobilenet/mobilenet_bcst_train.py
...
DATA_DIR = "dataset/bcst_aug"
EPOCHS = 20
BATCH_SIZE = 16
IMG_SIZE = 224
LR = 0.001
SAVE_DIR = "runs/classify/mobilenetv4_bcst"

if not os.path.isdir(os.path.join(DATA_DIR, "train")):
    raise SystemExit(f"Missing {DATA_DIR}. Build it first (train/val fire/non_fire).")
